...
data <- read.csv("C:/Users/my pc/DATA analysis project/Covid_19_analysis/COVID19_line_list_data.csv")
...
# 99% confidence: men have from 0.8% to 8.8% hiher chance of dying.
